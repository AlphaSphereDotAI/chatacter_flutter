...
class _VideoCallPageState extends State<VideoCallPage> {
      ...
      chatHistory = [
        {
          "role": "system",
          "content":
              "You are ${receiver!.name} ${receiver!.lastName}. Respond to the user's questions and comments as ${receiver!.name} ${receiver!.lastName} would, without explicitly stating that you are ${receiver!.name} ${receiver!.lastName}. Use very short sentences. Be polite and don't be rude."
        }
      ];
  ...
  void _checkActivity() {
    if (!(_speechToText?.isListening ?? false) && !_isSpeaking) {
      _handleSpokenText("*I speak with a low voice and you can not hear me*");
    }
  }
